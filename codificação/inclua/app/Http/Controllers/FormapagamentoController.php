...
class FormapagamentoController extends Controller
{
   function list($msg = null)
   {
      ...
      $lista = Formapagamento::where('descricao', 'like', "%" . "%")->orderBy('id', 'desc')->paginate(8);
   ...
   function search(Request $request)
   {
      ...
      $lista = Formapagamento::where('descricao', 'like', "%" . $request->filtro . "%")->orderBy('id', 'desc')->paginate(8);
