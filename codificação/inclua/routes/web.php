...
#CADASTRO DE USUARIO
Route::get("/cadastrar/usuario/create", [\App\Http\Controllers\UsuarioController::class, 'createUser'])->name('usuario.create')->middleware('check.domain')->middleware('throttle:3,1');
Route::post("/cadastrar/usuario/store", [\App\Http\Controllers\UsuarioController::class, 'storeUser'])->name('usuario.store')->middleware('check.domain')->middleware('throttle:3,1');
...
Route::get("/recuperar/{id?}", [\App\Http\Controllers\UsuarioController::class, 'recoverID'])->name('recover.mail')->middleware("check.domain");
...
Route::middleware('auth')->group(function () {
    ...
    Route::any("/recebimentos/criar/todos", [\App\Http\Controllers\RecebimentosController::class, 'criar_todas_solicitacao'])->name('root.recebimentos.criar.todos')->middleware('auth');
    ...
    Route::post("/especialista/pedidomedicamento/store", [\App\Http\Controllers\PedidoMedicamentoController::class, 'store'])->name('pedido_medicamento.store');
