      ...
      <div class="col-md-9"> 
         ...
         <div class="card">
                ...
                <div class="row">
                  <div class="col-md-12 px-8">
                    <div class="form-group">
                      ...
                      name="nome" required value="{{ old('nome',$entidade->nome)}}" maxlength="150">
                    </div>
                  </div>
                  <div class="col-md-12 px-8">
                    <div class="form-group">
                        <label id="labelFormulario">Razão social</label>
                        <input style="border-color: #C0C0C0" type="text" class="form-control" name="razaosocial"
                         required value="{{old('razaosocial',$entidade->razaosocial)}}" maxlength="150">
                    </div>
                  </div>
                <div class="col-md-12 px-8">
                  <div class="form-group">
            ...
            <div class="form-group">
              ...
              value="{{old('numero_atendimento_social_mensal',$entidade->numero_atendimento_social_mensal)}}" maxlength="150">
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 px-8">
                  <div class="form-group">
                    ...
                    <input id="cidade" style="border-color: #C0C0C0" type="text" class="form-control" 
                    name="cidade" required value="{{old('cidade',$entidade->cidade)}}" maxlength="150">
                </div>
              </div>
                <div class="col-md-12 px-8">
                <div class="form-group">
                  <label id="labelFormulario">Bairro</label>
                  <input id="bairro" style="border-color: #C0C0C0" type="text" class="form-control"
                   name="bairro" required value="{{old('bairro',$entidade->bairro)}}" maxlength="150">
              </div>
            </div>
            <div class="col-md-12 px-8">
                <div class="form-group">
                  <label id="labelFormulario">Rua</label>
                  <input  id="rua" style="border-color: #C0C0C0" type="text" class="form-control" name="rua" 
                  required value="{{old('rua',$entidade->rua)}}" maxlength="150">
              </div>
            </div>
              <div class="col-md-12 px-8">
              <div class="form-group">
                <label id="labelFormulario">Número</label>
                <input id="numero" style="border-color: #C0C0C0" type="text" class="form-control" 
                name="numero" required value="{{old('numero',$entidade->numero)}}" maxlength="150">
            </div>
          </div>
              ...
              <div class="form-group">
                ...
                <input style="border-color: #C0C0C0" type="number" step="0.000000000001" class="form-control" name="longitude" 
                required value="{{old('longitude',$entidade->longitude)}}" maxlength="150">
            </div>
          </div>
              <div class="col-md-12 px-8">
              <div class="form-group">
                <label id="labelFormulario">Latitude</label>
                <input style="border-color: #C0C0C0" type="number" step="0.000000000001" class="form-control" name="latitude" 
                required value="{{old('latitude',$entidade->latitude)}}" maxlength="150">
            </div>
          </div>
    ...
    <input type="hidden" name ="id" value="{{$entidade->id}}">
           ...
           <div class="card">
            ...
            <div class="form-group">
              ...
              <input style="border-color: #C0C0C0" type="text" class="form-control" name="nome_login"
               required value="{{old('nome_login',$usuario->nome_completo)}}" maxlength="150">
              </div>
            </div>
        <div class="col-md-12 px-8">
            <div class="form-group">
