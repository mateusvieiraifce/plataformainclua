...
<div class="row">
   <div class="col-lg-12 col-md-12">
      <div class="card card-tasks">
         ...
         <div class="card-body">
            <div class="table-responsive">
               <table class="table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>{{$ent->nome}}</td>
                        <td>
                           <a style="max-height: 35px;" href="{{route('paciente.marcarConsultaViaEspecialidadePasso3',[$especialidade_id,$ent->id])}}" class="btn btn-success">Próximo <i class="tim-icons icon-double-right"> </i> </a>
                        </td>
                        @endforeach
                        @endif
                  </tbody>
               ...
               <div>
                  ...
                  @php
                  $paginator = $lista;
                  $paginator->url = route('paciente.marcarConsultaViaEspecialidadePasso1');
                  @endphp
                  <ul class="pagination">
         ...
         <div class="col-2"> 
            <a href="{{route('paciente.marcarConsultaViaEspecialidadePasso1')}}" class="btn btn-primary"><i class="fa fa-reply"></i> Voltar</a>
            </div>
      </div>
   </div>
</div>
