   ...
   <div class="col-lg-12 col-md-12">
      <div class="card card-tasks">
         <div class="card-header">
            <h6 class="title d-inline">Escolha a especialidade </h6>
         </div>
               ...
               <table class="table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>{{$ent->descricao}}</td>
                        <td>
                           <a style="max-height: 35px;" href="{{route('paciente.marcarConsultaViaEspecialidadePasso2',$ent->id)}}" class="btn btn-success">Próximo <i class="tim-icons icon-double-right"> </i> </a>
                        </td>
                        @endforeach
                        @endif
                  </tbody>
