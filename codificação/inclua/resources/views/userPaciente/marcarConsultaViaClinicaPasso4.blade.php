            ...
            <div class="table-responsive">
               <table class="table">
                  ...
                  <td>{{date( 'd/m/Y H:i' , strtotime($ent->horario_agendado))}}
                   <td>                 
                       <a style="max-height: 35px;" href="#" target="_blank" rel="tooltip" title="Finalizar Consulta"
                           data-original-title="Alterar quantidade" href="#"
                           data-target="#modalFinalizarConsulta{{$ent->id}}" data-toggle="modal"
                           data-whatever="@mdo"
                           class="btn btn-success">Finalizar
                        </a>
                   </td>
                      <!-- Modal altera quanditade-->
                      <div class="modal" id="modalFinalizarConsulta{{$ent->id}}" 
                                    ...
                                    <div class="modal-body">
                                       <div class="container">
                                          ...
                                          <form method="post" action="{{route('paciente.marcarConsultaViaClinicaFinalizar')}}">
                                                ...
                                                <input type="hidden" value="{{$ent->id}}" id="consulta_id"
                                                name="consulta_id">
                                                ...
                                                <div class="modal-footer">
                                                   ...
                                                   <button type="submit"
                                                         class="btn btn-success">Confirmar consulta</button>              
                                                </div>
                                       </form>
                                    </div>
                                 </div>
