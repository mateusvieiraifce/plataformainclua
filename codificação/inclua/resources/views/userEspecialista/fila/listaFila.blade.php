...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card card-tasks" style="height: auto; min-height: 500px;">
                                ...
                                <table id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                                    ...
                                                    <td  style=" white-space: nowrap;">        <a  rel="tooltip" title="Iniciar atendimento" class="btn-primary" data-original-title="Edit"
                                                    href="{{route('especialista.iniciarAtendimento', [$ent->consulta_id,"prontuarioatual"])}}">
                                                    Iniciar atendimento
                                                    </a>  </tr> 
                                                </tr>
                                            @endforeach
            ...
            <div class="row">
                <div class="col-4">
                    <a href="{{route('fila.listClinicaDoEspecialista')}}" class="btn btn-primary"><i
