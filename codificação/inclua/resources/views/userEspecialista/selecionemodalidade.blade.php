    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                ...
                <a href="{{route('especialista.marcarconsulta.clinica.presencial', $pacientes)}}" class="btn btn-secundary btn-round btn-lg header-links">
                    <i class="tim-icons icon-single-02"></i>
                    <br>
                    <label style="width: 150px"> Consulta Presencial</label>
                </a>
                <a href="{{ route('especialista.marcarConsulta.clinica.presencial.data',[$pacientes, $especialista_id,true]) }}" class="btn btn-secundary btn-round btn-lg header-links">
